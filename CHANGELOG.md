...
### Added
- Added `typecheck` script to ensure that TypeScript files are type-checked.
...
[0.1.4-alpha]: https://github.com/Automattic/jetpack-videopress-core/compare/0.1.3...0.1.4-alpha
